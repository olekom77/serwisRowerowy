    ...
    <div className="flex flex-col md:flex-row">
      ...
      {!isMobileView && (
        ...
        >
          ...
          {selectedItem ? (
            <div>
              <h3 className="text-xl font-bold" style={{ paddingBottom: '10px' }}>Edytuj/Dodaj Element</h3>
              {(selectedItem[itemIdentifier] ? updateItemFields : addItemFields).map((field) => (
                <div key={field} className="mb-2">
                  ...
                  {fieldOptions && fieldOptions[field] && fieldOptions[field].type === 'combo' ? (
                    ...
                    >
                      <option value="">{fieldLabels[field] || 'Wybierz...'}</option>
      ...
      {isMobileView && showPopup && (
        <div className="popup-container Mobile">
          ...
          <div className="popup-content">
            ...
            {selectedItem ? (
              <div>
                <h3 className="text-xl font-bold">Edytuj/Dodaj Element</h3>
                {(selectedItem[itemIdentifier] ? updateItemFields : addItemFields).map((field) => (
                  <div key={field} className="mb-2">
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {fieldLabels[field]}
                    ...
                    {fieldOptions && fieldOptions[field] && fieldOptions[field].type === 'combo' ? (
                      ...
                      <>
                        <input
                          ...
                          className="mt-1 p-2 border rounded w-full"
                        />
                        {selectedItem[field] && fieldOptions[field].options.length > 0 && (
                          <select
                            name={field}
                            value={selectedItem[field] || ''}
                            onChange={handleInputChange}
