      ...
      <div className="container mx-auto p-4 md:px-10">
        <header className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center py-4 bg-gray-700 text-white shadow-md">
          <div className="flex items-center">
            ...
            <h1 className="text-lg md:text-2xl">System zarządzania sklepem rowerowym - Sebastian Szmigielski</h1>
          </div>
              ...
              <ul className="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-4">
                <li className="group relative">
                  ...
                  >
                    ...
                    <li>
                      <Link to="/order-statuses" className="block px-4 py-2" onClick={closeMenu}>
                        Status zleceń
                      </Link>
                    </li>
                    <li>
                ...
                <li className="group relative">
                  ...
                  >
                    ...
                    <li>
                      <Link to="/employee-assignments" className="block px-4 py-2" onClick={closeMenu}>
                        Przydział zleceń
                      </Link>
                    </li>
                  </ul>
